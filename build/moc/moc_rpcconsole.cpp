...
#include "../../src/qt/core/rpcconsole.h"
...
static const char qt_meta_stringdata_RPCConsole[] = {
    ...
    "count\0setNumBlocks(int)\0"
    "SetCoinSupply(uint,uint)\0nSupply,nIdealSupply\0"
    "SetPrimeInfo(double,uint,uint,double)\0"
    "nDiff,nReserves,nHeight,nRewards\0"
    "SetHashInfo(double,uint,uint,double)\0"
    "browseHistory(int)\0offset\0scrollToEnd()\0"
};
...
void RPCConsole::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: _t->SetCoinSupply((*reinterpret_cast< uint(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2]))); break;
        case 10: _t->SetPrimeInfo((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2])),(*reinterpret_cast< uint(*)>(_a[3])),(*reinterpret_cast< double(*)>(_a[4]))); break;
        case 11: _t->SetHashInfo((*reinterpret_cast< double(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2])),(*reinterpret_cast< uint(*)>(_a[3])),(*reinterpret_cast< double(*)>(_a[4]))); break;

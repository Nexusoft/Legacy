...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        mintOnlyLabel = new QLabel(AskPassphraseDialog);
        mintOnlyLabel->setObjectName(QString::fromUtf8("mintOnlyLabel"));

        formLayout->setWidget(1, QFormLayout::LabelRole, mintOnlyLabel);

        mintOnly = new QCheckBox(AskPassphraseDialog);
        mintOnly->setObjectName(QString::fromUtf8("mintOnly"));

        formLayout->setWidget(1, QFormLayout::FieldRole, mintOnly);

        passLabel1 = new QLabel(AskPassphraseDialog);
        passLabel1->setObjectName(QString::fromUtf8("passLabel1"));

        formLayout->setWidget(2, QFormLayout::LabelRole, passLabel1);
        ...
        formLayout->setWidget(2, QFormLayout::FieldRole, passEdit1);

        passLabel2 = new QLabel(AskPassphraseDialog);
        passLabel2->setObjectName(QString::fromUtf8("passLabel2"));

        formLayout->setWidget(3, QFormLayout::LabelRole, passLabel2);
        ...
        formLayout->setWidget(3, QFormLayout::FieldRole, passEdit2);
...
"}"));
        ...
        formLayout->setWidget(5, QFormLayout::FieldRole, capsLabel);
    ...
    void retranslateUi(QDialog *AskPassphraseDialog)
    {
        ...
        mintOnlyLabel->setText(QApplication::translate("AskPassphraseDialog", "Unlock for Mint Only?", 0, QApplication::UnicodeUTF8));

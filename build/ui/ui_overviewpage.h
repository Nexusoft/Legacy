...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        label->setMaximumSize(QSize(240, 240));
        label->setPixmap(QPixmap(QString::fromUtf8(":/icons/Nexus")));
        ...
        labelBalanceHeader = new QLabel(frame);
        labelBalanceHeader->setObjectName(QString::fromUtf8("labelBalanceHeader"));

        formLayout_2->setWidget(3, QFormLayout::LabelRole, labelBalanceHeader);

        labelBalance = new QLabel(frame);
        labelBalance->setObjectName(QString::fromUtf8("labelBalance"));
        labelBalance->setText(QString::fromUtf8("0"));

        formLayout_2->setWidget(3, QFormLayout::FieldRole, labelBalance);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        label_5->setText(QApplication::translate("OverviewPage", "Nexus Wallet", 0, QApplication::UnicodeUTF8));
        labelBalanceHeader->setText(QApplication::translate("OverviewPage", "Balance:", 0, QApplication::UnicodeUTF8));

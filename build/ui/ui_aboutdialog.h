...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        label_nexus_copyright = new QLabel(AboutDialog);
        label_nexus_copyright->setObjectName(QString::fromUtf8("label_nexus_copyright"));
        label_nexus_copyright->setWordWrap(true);
        label_nexus_copyright->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        verticalLayout_2->addWidget(label_nexus_copyright);
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Nexus", 0, QApplication::UnicodeUTF8));
        label_4->setText(QString());
        label->setText(QApplication::translate("AboutDialog", "<b>Nexus</b> version", 0, QApplication::UnicodeUTF8));
        label_nexus_copyright->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2011-2014 Peercoin / Nexus Developers", 0, QApplication::UnicodeUTF8));
        label_2->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2014 Videlicet ++\n"
"\n"

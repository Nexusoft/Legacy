...
namespace Core
{
    ...
    bool CBlock::VerifyStake() const
    {
        ...
        if(nThreshold < nRequired)
            return Invalid("threshold:invalid", error("CBlock::VerifyStake() : Coinstake / nNonce threshold too low %f Required %f. Energy efficiency limits Reached Coin Age %" PRIu64 " | Trust Age %" PRIu64 " | Block Age %" PRIu64, nThreshold, nRequired, nCoinAge, nTrustAge, nBlockAge));

...
namespace LLP
{
	...
	class MessageLLP : public Connection<NexusConnection>
	{	
	public:
		Net::CAddress addr;
		std::string addrName;
		...
		CoreLLP( Socket_t SOCKET_IN, DDOS_Filter* DDOS_IN, bool isDDOS = false ) : NexusConnection( SOCKET_IN, DDOS_IN ) 

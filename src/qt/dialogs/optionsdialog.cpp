        ...
        QWidget(parent)
{
    ...
    map_port_upnp->setToolTip(tr("Automatically open the Nexus client port on the router. This only works when your router supports UPnP and it is enabled."));
    layout->addWidget(map_port_upnp);

    connect_socks4 = new QCheckBox(tr("&Connect through SOCKS4 proxy:"));
    connect_socks4->setToolTip(tr("Connect to Nexus through a SOCKS4 proxy (e.g. when connecting through Tor)"));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show Nexus addresses in the transaction list"));
